...
const AddScoliosisExam = () => {
    ...
    return (
        <Box m='40px'>
            ...
            <Typography variant = "h4" sx={classes.title}> Scoliosis Screening </Typography>
            ...
            <Box sx={classes.formBox}>
                {isSmallScreen ? (
                    ...
                    <Box>
                        <Box display='flex'>
                            <Typography variant="h5" sx={classes.title} width='750px'>First Position:</Typography> 
                            <Typography variant="h5" sx={classes.title}>Comments</Typography> 
                        </Box>
                        <FormControl>
                            <Box display='flex' justifyContent='space-between' alignItems='center'>
                                <Box width='300px'>
                                    <FormLabel id="demo-row-radio-buttons-group-label" variant="h5" sx={classes.title}>Front, Standing position</FormLabel>
                                </Box>
                                <Box width='250px'>
                                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group" >
                                        <FormControlLabel value="female" control={<Radio />} label="Normal" />
                        ...
                        <Box display='flex' mt='40px'>
                            <Typography variant="h5" sx={classes.title} width='750px'>Second Position:</Typography> 
                            <Typography variant="h5" sx={classes.title}>Comments</Typography> 
                        </Box>
                        <FormControl>
                            <Box display='flex' justifyContent='space-between' alignItems='center'>
                                <Box width='300px'>
                                    <FormLabel id="demo-row-radio-buttons-group-label" variant="h5" sx={classes.title}>Front, bending forward<br />(Adams forward bend test)</FormLabel>
                                </Box>
                                <Box width='250px'>
                                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group" >
                                        <FormControlLabel value="female" control={<Radio />} label="Normal" />
                        ...
                        <Box display='flex' mt='40px'>
                            <Typography variant="h5" sx={classes.title} width='750px'>Third Position:</Typography> 
                            <Typography variant="h5" sx={classes.title}>Comments</Typography> 
                        </Box>
                        <FormControl>
                            <Box display='flex' justifyContent='space-between' alignItems='center'>
                                <Box width='300px'>
                                    <FormLabel id="demo-row-radio-buttons-group-label" variant="h5" sx={classes.title}>Back, Standing position</FormLabel>
                                </Box>
                                <Box width='250px'>
                                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group" >
                                        <FormControlLabel value="female" control={<Radio />} label="Normal" />
                        ...
                        <Box display='flex' mt='40px'>
                            <Typography variant="h5" sx={classes.title} width='750px'>Fourth Position:</Typography> 
                            <Typography variant="h5" sx={classes.title}>Comments</Typography> 
                        </Box>
                        <FormControl>
                            <Box display='flex' justifyContent='space-between' alignItems='center'>
                                <Box width='300px'>
                                    <FormLabel id="demo-row-radio-buttons-group-label" variant="h5" sx={classes.title}>Back, bending away<br />(Adams forward bend test)</FormLabel>
                                </Box>
                                <Box width='250px'>
                                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group" >
                                        <FormControlLabel value="female" control={<Radio />} label="Normal" />
                        ...
                        <Box display='flex' mt='40px'>
                            <Typography variant="h5" sx={classes.title} width='750px'>Fifth Position:</Typography> 
                            <Typography variant="h5" sx={classes.title}>Comments</Typography> 
                        </Box>
                        <FormControl>
                            <Box display='flex' justifyContent='space-between' alignItems='center'>
                                <Box width='300px'>
                                    <FormLabel id="demo-row-radio-buttons-group-label" variant="h5" sx={classes.title}>Side, bending position<br />(Adams forward bend test)</FormLabel>
                                </Box>
                                <Box width='250px'>
                                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group" >
                                        <FormControlLabel value="female" control={<Radio />} label="Normal" />
...
export default AddScoliosisExam;